$(document).ready(function() {
  ...
  function selectItem(item) {
    ...
    if(mentorList.length === 0) {
      yourMentor.html("<h3>No Mentor Assigned!<h3><p>I'm Sorry, there is currently no mentor assigned to that department. Please contact <a href='mailto:gkaminski@pcc.edu'>Greg Kaminski</a> for more information about the Distance Learning Faculty Mentor Program at PCC.</p>");
